...
public class BasicoJPQLTest extends EntityManagerTest {
    ...
    public void selecionarUmAtributoParaRetorno() {
        ...
        TypedQuery<Cliente> clienteTypedQueryCliente = entityManager.createQuery(jpqlCliente, Cliente.class);
        List<Cliente> listaClientes = clienteTypedQueryCliente.getResultList();
