...
insert into produto (id, nome, preco, data_criacao, descricao) values (4, 'Notebook Gamer', 12500.0, date_sub(sysdate(), interval 1 day), 'O melhor da categoria.');
...
insert into pedido (id, cliente_id, data_criacao, data_ultima_atualizacao, total, status) values (2, 1, sysdate(), sysdate(), 499.0, 'AGUARDANDO');
