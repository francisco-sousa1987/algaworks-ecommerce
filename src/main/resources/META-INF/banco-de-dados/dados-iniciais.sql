...
insert into produto (id, nome, preco, data_criacao, descricao) values (2, 'Câmera GoPro Hero 8', 2320.0, date_sub(sysdate(), interval 1 day), 'A melhor câmera pra você.');
...
insert into cliente (id, nome, cpf) values (3, 'Marina Matos', '222');
...
insert into cliente_detalhe (cliente_id, sexo, data_nascimento) values (3, 'FEMININO', date_sub(sysdate(), interval 32 year));
...
insert into pedido (id, cliente_id, data_criacao, total, status) values (5, 2, sysdate(), 499.0, 'PAGO');
